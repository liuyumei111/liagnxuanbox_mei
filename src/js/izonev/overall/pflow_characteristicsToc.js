'use strict';
app.controller('ocharacteristicsTocCtrl', ['$scope', '$http', '$state', '$q', '$interval', function ($scope, $http, $state, $q, $interval) {
        ...
        if ($scope.app.exhibition.dataflag) {
            ...
            mainhttp.funfindChartData().then(function () {
                if ($scope.alllabel.length != 0) {
                    ...
                    $http({
                        method: 'GET',
                        url: USP_SERVER_ROOT1 + 'project/module/feature' + '?proId=' + $scope.projectId,
